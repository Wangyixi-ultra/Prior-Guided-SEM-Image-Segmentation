...
# ---------- 1. 原始 nnUNet 路径 ----------
TRAIN_IMG_DIR   = Path('U-Mamba/data/nnUNet_raw/Dataset111_Perovskite/imagesTr')
TRAIN_LABEL_DIR = Path('U-Mamba/data/nnUNet_raw/Dataset111_Perovskite/labelsTr')
TEST_IMG_DIR    = Path('/home/chen/seg6/U-Mamba/data/nnUNet_raw/Dataset111_Perovskite/imagesTs')
TEST_LABEL_DIR  = Path('/home/chen/seg6/U-Mamba/data/nnUNet_raw/Dataset111_Perovskite/labelsTs')
...
level_3_transform = A.ReplayCompose([
    ...
    A.OneOf([
        ...
        A.RandomGamma(gamma_limit=(90, 111), p=1.0),
    ], p=1.0),
], additional_targets={'mask': 'mask'})
...
level_4_transform = A.ReplayCompose([
    A.Affine(scale=(0.9, 1.1), translate_percent=(-0.1, 0.1), rotate=0,
             interpolation=cv2.INTER_NEAREST, p=1.0),
    A.OneOf([
        A.ElasticTransform(alpha=111, sigma=111*0.05, interpolation=cv2.INTER_NEAREST, p=1.0),
