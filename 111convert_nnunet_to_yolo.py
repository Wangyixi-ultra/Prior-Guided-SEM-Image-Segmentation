...
def convert_mask_to_yolo_format(mask, original_class_id, yolo_class_id):
    ...
    for contour in contours:
        ...
        # 添加YOLO检测格式标注: class_id center_x center_y width height
        yolo_annotations.append([yolo_class_id, center_x, center_y, norm_w, norm_h])
...
def main():
    ...
    target_dataset_path = "/home/chen/seg6/U-Mamba/data/nnUNet_raw/Dataset111_Perovskite_YOLO"
