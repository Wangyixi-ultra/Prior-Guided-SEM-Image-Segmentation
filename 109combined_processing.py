...
# ---------- 1. 原始 nnUNet 路径 ----------
TRAIN_IMG_DIR   = Path('U-Mamba/data/nnUNet_raw/Dataset109_Perovskite/imagesTr')
TRAIN_LABEL_DIR = Path('U-Mamba/data/nnUNet_raw/Dataset109_Perovskite/labelsTr')
TEST_IMG_DIR    = Path('/home/chen/seg6/U-Mamba/data/nnUNet_raw/Dataset109_Perovskite/imagesTs')
TEST_LABEL_DIR  = Path('/home/chen/seg6/U-Mamba/data/nnUNet_raw/Dataset109_Perovskite/labelsTs')
...
level_3_transform = A.ReplayCompose([
    ...
    A.OneOf([
        A.GaussNoise(std_range=(0.08, 0.3), p=1.0),
...
level_4_transform = A.ReplayCompose([
    A.Affine(scale=(0.9, 1.1), translate_percent=(-0.1, 0.1), rotate=0,
             interpolation=cv2.INTER_NEAREST, p=1.0),
    A.OneOf([
        A.ElasticTransform(alpha=110, sigma=110*0.05, interpolation=cv2.INTER_NEAREST, p=1.0),
    ...
    A.OneOf([
        A.GaussNoise(std_range=(0.1, 0.4), p=1.0),
