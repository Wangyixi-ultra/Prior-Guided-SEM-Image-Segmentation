...
OUTPUT_DIR  = Path('/home/chen/seg6/predict_no_label/experiment/out112')      # nnUNet 预测结果
BORDER_DIR  = Path('/home/chen/seg6/predict_no_label/experiment/border112')   # 轮廓叠加图
JSON_DIR    = Path('/home/chen/seg6/predict_no_label/experiment/json112')                 # JSON标注文件输出目录
# nnUNet 参数
DATASET_ID  = 112
CONFIG      = '2d'
FOLD        = 0
