#!/usr/bin/env python3
"""
对Dataset110_Perovskite数据集下的所有trainer进行测试集对比评估
...
# ========== 配置 ==========
DATASET_NAME = "Dataset110_Perovskite"
...
def get_all_trainers():
    """获取Dataset110_Perovskite下所有的trainer模型"""
...
def main():
    print(f"{'='*80}")
    print("Dataset110_Perovskite 测试集对比评估 (优化版-单通道)")
    print(f"{'='*80}")
    ...
    # Dataset110 为单通道，直接使用 RAW_TEST_IMAGES
